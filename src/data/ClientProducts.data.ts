...
const Data: ClientProductsData[] = [
  {
    ...
    content: "/assets/textfile/nisi-group/jetmag-pro.txt",
    publishDate: new Date(2024, 4, 30).toString(),
    tags: ["products", "camera", "lens"],
    nextId: "nisi-group/circular-filters",
  },
  {
    ...
    content: "/assets/textfile/nisi-group/circular-filters.txt",
  ...
  },
  {
    ...
    content: "/assets/textfile/nisi-group/square-filters.txt",
    publishDate: new Date(2024, 12, 15).toString(),
    nextId: "nisi-group/cinema",
    prevId: "nisi-group/circular-filters",
  },
  {
    ...
    content: "/assets/textfile/nisi-group/cinema.txt",
  ...
  },
  {
    ...
    content: "/assets/textfile/nisi-group/lenses.txt",
  ...
  },
  {
    ...
    content: "/assets/textfile/nisi-group/accessories.txt",
