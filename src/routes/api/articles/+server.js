...
export async function GET({fetch, url}) {
  ...
  // const SINGLE_PARAM_KEYS   = ["group", "subgroup"];
  ...
  try {
    ...
    // let singlesPass = SINGLE_PARAM_KEYS
    //   .map(paramKey => {
    //     return query.get(paramKey) ? item[paramKey] === query.get(paramKey) : true
    //   })
    //   .every(truth => truth);
    ...
    // relevancy score filter
      ...
      // return relevancyScorePass && singlesPass;
